    ...
    focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="p-2 w-full flex justify-around mt-4">
                                <button type="button" onclick="location.href='{{ route('owner.images.index') }}'"
                                    class="mx-auto text-white bg-indigo-500 border-1 py-2 px-8 focus:outline-none hover:bg-gray-600
                    ...
                    <form id="delete_{{ $image->id }}"
                        ...
                        <div class="p-2 w-full flex justify-around mt-32">
                            <a href="#" data-id="{{ $image->id }}"onclick="deletePost(this)"
                                class=" mx-auto text-white bg-red-500
                        border-0 py-2 px-12 focus:outline-none hover:bg-red-600 rounded "style="background: red">削除する</a>
                        </div>
                    </form>
