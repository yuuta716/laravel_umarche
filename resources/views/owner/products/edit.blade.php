                                            ...
                                            <optgroup label="{{ $category->name }}">
                                                ...
                                                @foreach ($category->secondary as $secondary)
                                                    <option value="{{ $secondary->id }}">
                                                        {{ $secondary->name }} @if ($secondary->id === $product->secondary_category_id)
                                                            selected
                                                        @endif
                                                    </option>
                                                @endforeach
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                            <div class="relative flex justify-around">
                                ...
                                <div><input type="radio" name="is_selling" value="0" class="mr-2"
                                        @if ($product->is_selling === 0) { checked } @endif>停⽌中</div>
                            </div>
                        </div>
                ...
                <form id="delete_{{ $product->id }}"
                    ...
                    <div class="p-2 w-full flex justify-around mt-32">
                        <a href="#" data-id="{{ $product->id }}"onclick="deletePost(this)"
                            class=" mx-auto text-white bg-red-500 border-0 py-2 px-12 focus:outline-none hover:bg-red-600
                    rounded "style="background: red">削除する</a>
                    </div>
                </form>
            </div>
        </div>
