                        ...
                        <div class="container md:md:px-5 py-24 mx-auto">
                            ...
                            <div class="flex justify-end mb-4">
                                <button onclick="location.href='{{ route('admin.owners.create') }}'"
                                    class=" text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規作成</button>
                            </div>
                                                ...
                                                <form id="delete_{{ $owner->id }}" method="post"
                                                    ...
                                                    <td class="md:px-4 py-3">
                                                        <a href="#" data-id="{{ $owner->id }}"
                                                            ...
                                                            class=" mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red600 rounded "
